...
import { LOGIN_REQUEST, LOGIN_ERROR, LOGOUT_REQUEST, loginError, loginSuccess } from 'actions/auth'
...
export const requestLogout = token => {
  ...
  const url = `${process.env.REACT_APP_COLAB_API_URL}/api/v1/authentication/admin/logout/`
